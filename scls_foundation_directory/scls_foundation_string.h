...
namespace scls {
    ...
    public:
        ...
        __XML_Text_Base* parent()const;
        void set_this_object(std::weak_ptr<__XML_Text_Base> new_this_object);
        ...
        __XML_Text_Base* sub_text(int index)const;
        std::vector<std::shared_ptr<__XML_Text_Base>>& sub_texts() ;
